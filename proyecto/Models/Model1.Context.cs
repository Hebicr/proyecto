...
namespace proyecto.Models
{
    ...
    public partial class ProyectoProgra6Entities : DbContext
    {
        ...
        public virtual ObjectResult<sp_getClientexadiciones_Result> sp_getClientexadiciones(Nullable<int> idCliente)
        {
            var idClienteParameter = idCliente.HasValue ?
                new ObjectParameter("idCliente", idCliente) :
                new ObjectParameter("idCliente", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_getClientexadiciones_Result>("sp_getClientexadiciones", idClienteParameter);
        }
